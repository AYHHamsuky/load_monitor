<?php
/**
 * View 11kV Interruption Detail
 * Path: /app/views/interruptions_11kv/view_detail.php
 */
    ...
    <div class="detail-card">
        <div class="page-header">
            <div class="page-title">
                <span>⚡</span> 11kV Interruption Details
            </div>
            <div class="action-buttons">
                <a href="index.php?page=interruptions_11kv" class="btn-back">← Back to List</a>
                <?php if ($canEdit): ?>
                    <a href="index.php?page=interruptions_11kv&action=edit&id=<?= $interruption['id'] ?>" class="btn-edit">
                        ✏️ Edit
                    </a>
        ...
        <div class="status-banner">
            <div class="interruption-id">11kV Interruption #<?= $interruption['id'] ?></div>
        ...
        <div class="timeline">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-value" style="color: #16a34a;">
        ...
        <div class="detail-grid">
            <div class="detail-item">
                <div class="detail-label">11kV Feeder</div>
                <div class="detail-value"><?= htmlspecialchars($interruption['fdr11kv_name']) ?></div>
                <div style="font-size: 12px; color: #6b7280; margin-top: 4px;">
                    Code: <?= htmlspecialchars($interruption['fdr11kv_code']) ?>
                </div>
                <div style="font-size: 12px; color: #6b7280; margin-top: 2px;">
                    Parent: <?= htmlspecialchars($interruption['parent_feeder']) ?>
                </div>
            </div>
...
function deleteInterruption(id) {
    if (!confirm('🗑️ Are you sure you want to delete this 11kV interruption record? This action cannot be undone.')) {
        return;
    }
    
    fetch('ajax/interruption_11kv_delete.php', {
        method: 'POST',
