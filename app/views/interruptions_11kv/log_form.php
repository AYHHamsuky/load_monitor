<?php
/**
 * 11kV Interruption Form — single file, three modes
 * Path: /app/views/interruptions_11kv/log_form.php
 *
 * $mode:
 *   'new'      → Stage-1 active, Stage-2 grayed
 *   edit           → Stage 1 editable (1-hr window)
 ...
 * $feeders_11kv  → passed by controller
 */
...
document.getElementById('interruptionForm').addEventListener('submit', function(e) {
    ...
    const url   = isNew ? 'ajax/interruption_11kv_log.php' : 'ajax/interruption_11kv_complete.php';
