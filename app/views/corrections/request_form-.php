                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrapper">
                                ...
                                <select name="entry_hour" required style="padding-left: 2.75rem;">
                            ...
                            <div class="form-hint">
                                <i class="fas fa-info-circle"></i>
                                Select the operational hour (00:00–23:59) you want to correct
                            </div>
                        </div>
                    </div>
                </div>
        ...
        case 'load_read':
            inputHtml = `
                ...
                <input type="number" name="new_value" id="newValue" 
                       ...
                       placeholder="Enter load reading (e.g., 5.50)" style="padding-left: 2.75rem;">
            `;
            hintText = '<i class="fas fa-info-circle"></i> Enter load reading in megawatts (MW) using decimal format (e.g., 5.50)';
            break;
